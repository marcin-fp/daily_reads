...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9iHQHc4_6n9SmlImWAOt_s3ncXims1RiLPl-uz_EdbT1-Wa36Y1xr0QZgG5NKe23tvGj-1sWxcPthq_NNUXpqRow0fPGrc-47PfyV2pn3QgX97mwGI7g6Mk8KtGdFL47cISi06=w1280-h144-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8NZlctF_lHeprreUr7j3vD8GVMF8ENCdv2UXgPYPOD6vqXpDG5a5FKeXvYWXkXg4SkY4ZgX9CzEWTsrG8QtsZakFuap2IceRGZMFBA12zOiKSPXXTQuX7SnsfqD2bIzVskGgMvag=w1084-h186-v0?authuser=0)
...
1
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-hFiXvYy9jXb4ijwouw7QMDpYamkz9ZUnuToEMHcWNl_tEtKsJiqYLx_67APYUHxCLlaJSrQAD5EEUXTnahQn27ZSmCI_duX07NnTjssalg_iHSzw17Xw5PYmGyDdrdqEQ5_Qkiw=w667-h450-v0?authuser=0)
...
PostTrainBench Model × × Parameter training Held-out tasks SEA-Eval Agent Partial × Sequential
adaptation Long-term evolution
SEAGym Agent harness Partial × Prompt, memory, tool, workflow updates
ID/OOD transfer
PAST-Bench Agent memory Partial × Retained cross-session experience
Matched on/off conditions
ContinualSkillBench Skill library Partial × In-context skill accumulation
Cross-task reuse
FinEvo-Bench Agent Partial × Longitudinal experience
Longitudinal task sequences
Social Gym Agent Partial × Tournament self-play
Rule-verifiable outcomes
**S3Gym**Agent behavior ✓ ✓ History ICL, Summary Memory, Training
...
R(p) t = Explore → Judge → Consolidate → Updatep → Evaluate, (1)
...
6
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-2t5stuDrwxvYooZ5Uihyn5GbIxJgcnroLx4nWhhC6yBqLBxQcmGv9acHlezMcXf43rRs-3kb3BEnX3JCqmu2fN42j8c-JsW4ZJrkEp5-rdbzGg5vLxC47alf7A3qtsRcRpwbiIw=w1280-h786-v0?authuser=0)
...
Ox,0 = Reset(seedx, cx), (2)
Hx,0 = ∅, (3)
where cx denotes the game configuration.
At each step, the agent receives the current observation, the within-episode history, and the pathway-specific experience state Z
(p) t inherited from previous exploration episodes. Following the actual interaction interface,
the model jointly produces an action and a self-judged immediate score:
(ax,i, sx,i) = πθt
( Ox,i, Hx,i;Z
(p) t
) , (4)
...
Hx,i+1 = Hx,i ⊕ Format (Ox,i, ax,i, sx,i, Fx,i, Ox,i+1) , (6)
...
Ct+1 = Serialize(Ct, T exp t ,Sexp
t ) , (8)
where T exp t and Sexp
...
Mt+1 = Summarize(Mt, T exp t ,Sexp
t ) . (9)
...
Each game provides an exploration distribution Cexp g and an evaluation distribution Ceval
...
(p)
t,g − Y 0,g. (13)
We report both the final evaluation score and ∆ (p) t,g . The former measures final capability, while the latter
measures how effectively the model benefits from its own interaction history.
...
Same rules as exploration but 22 pieces. 5
Minesweeper 9× 9 board with 10–20 mines and two extra lives.
The first mine hit terminates the episode.
64
Nullify Expressions generated with 3–7 construction steps.
Expressions generated with 5–10 construction steps.
50
Plants-vs-Zombies 3× 7 battlefield. 5× 6 battlefield. 64 Snake Collisions and invalid actions are
treated as no-ops. Collisions and invalid actions terminate the episode.
64
Tetris 10× 10 board. 8× 8 board. 64 Trust Evolution Opponent sampling is biased toward eas-
ier strategies. Opponent strategies are sampled uniformly.
10
...
10
**Setting Value**
History-ICL input limit 100,000 tokens Output generation cap 14,000 new tokens per response Controller interaction cap 64 steps per episode Exploration budget 30 exploration episodes Evaluation interval Every 3 exploration episodes Evaluation set size 3 strict-mode episodes per checkpoint Evaluation checkpoints x ∈ {0, 3, 6, . . . , 30}
...
**(a) Average score (Avg.) Model Chess Minesweeper Nullify Tetris Snake PvZ TrustEvo**
**ICL (History Context)**GPT-4o 0.007 0.044 0.030 0.030 0.212 11.636 8.242 GPT-4.1 0.010 0.042 0.030 0.152 0.515 16.909 7.371 o3-mini 0.012 0.222 0.030 1.273 4.000 26.333 9.242 Gemini-2.5-Flash 0.009 0.063 0.030 0.121 1.424 20.697 9.008 Gemini-2.5-Pro 0.025 0.421 0.212 0.273 1.576 28.242 14.500 GPT-5.5 0.017**0.604 0.545 4.242 9.061**44.033 7.848 Gemini-3.5-Flash**0.547**0.482 0.394 1.970 8.455**44.697 17.242**
**Summary Memory**GPT-4o 0.005 0.013 0.000 0.030 0.303 11.818 13.947 GPT-4.1 0.010 0.012 0.030 0.182 0.545 14.727 13.371 o3-mini 0.006 0.425 0.061 1.788 6.727 26.424 7.174 Gemini-2.5-Flash 0.074 0.438 0.091 0.152 1.364 21.939 8.720 Gemini-2.5-Pro 0.110 0.466 0.182 0.545 1.273 19.667 9.568 GPT-5.5**0.533 0.742 0.576 3.515 10.697**33.500 8.697 Gemini-3.5-Flash 0.208 0.603 0.455 1.091 10.242**43.879 14.394 (b) Maximum score (Max.) Model Chess Minesweeper Nullify Tetris Snake PvZ TrustEvo**
**ICL (History Context)**GPT-4o 0.018 0.131 0.333 0.333 0.667 17.667 11.500 GPT-4.1 0.018 0.189 0.333 0.667 1.667 21.667 10.250 o3-mini 0.022 0.500 0.333 2.667 9.667 29.333 13.250 Gemini-2.5-Flash 0.022 0.670 0.333 0.333 2.333 29.000 13.583 Gemini-2.5-Pro 0.089 0.659 0.667 1.000 4.333 33.000 19.000 GPT-5.5 0.067**0.974 1.000 11.333**11.333 48.000**23.000**Gemini-3.5-Flash**0.742**0.705**1.000**3.000**13.000 62.667**21.000
**Summary Memory**GPT-4o 0.018 0.033 0.000 0.333 1.000 20.333 19.333 GPT-4.1 0.031 0.083 0.333 0.667 1.000 19.333 15.917 o3-mini 0.018 0.608 0.333 4.000 10.333 29.000 10.083 Gemini-2.5-Flash 0.147 0.665 0.333 0.667 2.333 26.333 13.750 Gemini-2.5-Pro 0.258 0.974 0.333 2.000 3.000 26.667 14.333 GPT-5.5**0.773 1.000 1.000 6.667 14.000**41.333 17.000 Gemini-3.5-Flash 0.524 0.961**1.000**2.333 12.000**51.667 20.333**
**(c) Positive area above baseline (AUC+) Model Chess Minesweeper Nullify Tetris Snake PvZ TrustEvo**
**ICL (History Context)**GPT-4o 0.233 1.437 0.500 1.000 0.000 0.052 3.443 GPT-4.1 0.186 1.329 1.000 0.000 8.501 129.000 5.966 o3-mini 0.004 0.000 1.000 0.000 0.000 5.383 62.638 Gemini-2.5-Flash 0.017 0.000 1.000 0.000 7.317 24.402 6.251 Gemini-2.5-Pro 0.000**3.539 1.500**0.000 0.000 60.416 161.876 GPT-5.5 0.474 0.959 1.000**96.251**0.163**548.499**164.411 Gemini-3.5-Flash**12.280**1.217 0.417 34.000**37.387**161.945**200.000**
**Summary Memory**GPT-4o 0.007 0.046 0.000 0.500 1.917 12.778 10.350 GPT-4.1 0.177 0.046 1.000 0.000 0.000 75.462 154.876 o3-mini 0.079 0.001 2.000 28.598 0.300 40.425 30.521 Gemini-2.5-Flash 2.147**7.794**3.000 0.500 0.000**238.501**18.443 Gemini-2.5-Pro 0.573 0.721 0.000 10.084**11.321**11.872 10.624 GPT-5.5**16.840**2.951**7.418 50.801**0.000 33.219**240.500**Gemini-3.5-Flash 0.000 0.793 5.584 15.808 0.750 123.535 55.095
Note. AUC+ is computed over checkpoints x ∈ {0, 3, . . . , 30} using piecewise-linear trapezoidal integration of ∫ 30 0
max(0, y(x) − y0) dx. Means and maxima exclude explicitly marked invalid concurrency points; for AUC+, adjacent valid checkpoints are connected. Models with unfinished results in any game are omitted.
12
0 5 10 15 20 25 30 Exploration episodes
0.0
0.2
0.4
0.6
...
or e
**ICL Chess**
GPT-4.1 GPT-4o Gemini 2.5 Flash Gemini 2.5 Pro Gemini 3.5 Flash GPT-5.5 o3-mini
0 5 10 15 20 25 30 Exploration episodes
0.0
0.2
0.4
...
13
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-jL0ZKmrJFrbkjij9boG0m3Y45nvQYKaE13VkzTZni6umEwD6bkau1EDP6juOkitylzONLuU-37DouL2aoRKi7AhB55_OOXuuzO_rtiYfFzF2ePEmd_ghV5QA5fRK800GlNxQQ=w292-h192-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9WrlbBgKIMSu8UP8tul6RTb1yk4GE_iWfQhovd4FY-zHGpchwpFRj1FzH5tvzTxjaA7NSVOJhW6ddd6nheS_wc8Y7ifpsdg7JyMSO66BRumfdnXBwPV_SiYz9SJ-TMd9auahRRFg=w292-h192-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_nOf8bqsGqRAd-ltKZq0Pmx6ti5SU5SyYxAGIyI8AHRuzFI54aSg-P8IjlgbIsLSxMYILbHFMfVSmZaPQO1GCgCBpGXnwqBmfBIdR32YRM4Wosjgin8tDyvZ54ifd6_braWlvlRg=w292-h192-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-UdDU1VJaosucVixMmsM-2e6b7olPpGcZhR6L5FmlMLS3esKIqonHzgj1HaSIjAX30GfUd8s72VSb84Aen0bp-2bSzAGueDdRZIBZ4mTaCTcBoPs3mvjmYV-E3dfp26DcKRlzctQ=w292-h192-v0?authuser=0)
...
14
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9cVKGAQ6BuW97HcKg_16eECKYCp3Nn6r8v3FpIHwNDFuQ6HQwNI7L3i4he0cZuW3OCbY5qmozD10vjaGq6_kc-BS9GGymt9pamE_RYUePwSWH5Pa0psl3CkGxxOfGPChFOZer3AA=w292-h192-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8TzolMGERGl59yigj9dlJVDW9hwLR3VdJqJm57R0TbYpVuQAHg7zT_whirb44HhVOEtUe9DXgzcZF413y6opeEMXPg0TECWkxviDU6R1auNRPrFQwTc1LURncezQiE9_1JiVeD=w292-h192-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-mfeSERD_PBRNg8ElG020cpNfNWiyzeFKsby5_Nlavc84-DUxp_4wj2hBbXZ8xfoj_a-spIKCBSTqAv55K1OPrs39xgO2IQk9DpkidTnBxFmYOXui5va5cHsuvRwtPjZcy-us3HQ=w292-h193-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9Ek1vZEBY6oNtMmSXD0Wf7rlinJ83zg6VrnBcayQJeZ9Qh1Mswpg4ODHTcvbv0g4g-Jk9HM4VYVL2Id4erM4BYRF6IU8U95VotOqgMx81DRxor9czoCbD8f-vJbboNaSgs_ET0Ww=w292-h193-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9eQuiolPnUxYgW6UVn0qOt98wNocb3AzfcJ7leBOSvkh3kLhKC_2TijBsxU9OzTl0bsMeebSCU9b4aJxADfmDpkAmi0sLES6edqeq9_GE0s3u_HfNzToUfC2Te5Jlq3_mdw_DRVA=w292-h193-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-4VAkm5waII__ohaHvjS63yPRxFKmlF9WDdzV6O24dOAgmk89KsSMNF6ahej01Kb5uShwJA_WZ6-Wzz7mxFnmhkB70UHInbWNLmL_cl2wE3ER-VSnol3tZbBYx39JRijCtKXmQGg=w292-h193-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9JigDAcWskF50MCt2cOOMt4tJCUsp5WnCP_IoeEzAr1QgiQ7h0arQlWKU03sqLlRgl6MfxY_3aD316lQszgkdlwm-UoSdIDFO3c5PP-XWgt9pTYuetFy9VyEBryA35SgpM9ta2Hg=w292-h193-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-WDh2yFv63kVTyVr487bPfapqQja60gHVtiD4gkINmL8bHiNRe07H6qGyb0vBDdm8XlAdQFQ8Aavkt_Rv3J0_LqozO_aSu6yfeYXYEC6fLpSq-49pmarZ2iAV2YBmtFTgZDb2y=w292-h193-v0?authuser=0)
...
0.0 2.5 5.0 7.5 10.0 12.5 15.0 17.5 Episode
0
5
10
15
...
15
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX90byAOHDJrWa5ePWJ7dYRxy2XDNDRQ_i80Z6fEbO_mwrFTF0ZoJKmV4esCooHvJdGkp231WKjvbQDrJROLTG4z5VDa6XA2fwL66tg5OVEzJFs5q9Un0MosHczHRiBnF3JUCyei=w292-h193-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9cpKkdEHrGvO94J-pCy5BmclhThCjUVoQ0IXNRjfM9M0lCUCWAjMNLTU5qQzUMgMmcfn4p2SMH726PoojwBJwb0v42jdGA8k5lIwSbtp5F-YQu-doVq5W6vicXYVuG1VMeRgTvhg=w292-h193-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_UPVwaQ_I_y20EvhUm1e2TWM_U40etlBVTH5HEwRkp2B_M9HFIDSdKPUGkyj3trGTmZCsjyCUehfbQ_8lbX373h2Taa_AZ2kxwdxh0hc21vfM-Yk-8gaThunyxRxxUyLr6aVfr=w584-h307-v0?authuser=0)
...
rmax − rmin
∣∣∣∣ . (22)
We also measure over-confidence, Pr(si > 0, ri ≤ 0), and under-confidence, Pr(si ≤ 0, ri > 0). The analysis covers the seven target models and games under both direct-history and summary-memory conditions, comprising 98 runs and 116,117 transitions.
**Game Agreement NMAE Over-conf. Under-conf.**
Chess 0.496 0.141 0.365 0.139 Minesweeper 0.820 0.524 0.062 0.118 Nullify 0.827 0.056 0.170 0.004 PvZ 0.881 0.882 0.032 0.087 Snake 0.879 0.121 0.110 0.011 Tetris 0.846 0.041 0.151 0.002 Trust 0.665 0.392 0.291 0.044
...
gt = yt − yt−3
maxg,τ yg,τ −ming,τ yg,τ . (23)
We then measure ρ(At, gt) and ρ(−Et, gt), together with the difference in average score gain between the highest- and lowest-quality judgment tertiles.
**Game**ρ(A,g) ρ(−E, g) GapA GapE
All -0.010 -0.018 -0.004 -0.016 Chess -0.014 -0.058 0.028 -0.039 Minesweeper 0.071 0.006 0.069 0.005 Nullify -0.032 -0.082 -0.065 -0.058 PvZ -0.038 -0.023 0.014 0.010 Snake 0.022 0.022 0.009 0.009 Tetris -0.048 -0.021 0.010 0.004 Trust -0.014 -0.003 -0.001 0.006
...
NABA = AUC+
max(y0, ϵ) ,
where y0 is the initial evaluation score and ϵ denotes the first non-zero score scale when y0 = 0. Event agreement exhibits only weak negative correlations with NABA under both Pearson and Spearman measures (r = −0.23 and ρ = −0.11), while the positive-reward and positive-self-score rates show only weak positive correlations. These results indicate that accurate local**Self-Judging**alone is insufficient for**Self-Improvement:**agents must also transform feedback into reusable state abstractions, decision rules, and exploration strategies.
17
...
Chess 7 3 3 1 3.37 Minesweeper 7 3 4 0 -1.12 Nullify 7 4 2 1 2.79 PvZ 7 3 4 0 -2.11 Snake 7 3 4 0 -0.81 Tetris 7 5 1 1 6.20 Trust 7 4 3 0 8.43
...
GPT-5.5 / Trust
**Summary direction.**Always defect when the observed payoff structure consistently favors defection; avoid unnecessary reciprocal exploration.**Trajectory evidence.**At the first decision, the agent selected cheat and received an environment reward of 3.0.**Outcome.**∆NABA = +66.89.**Takeaway.**The summary translates payoff feedback into an explicit opponent-conditioned policy.
o3-mini / Tetris
**Summary direction.**Jointly inspect the current and next blocks, test alternative rotations, prioritize line-clearing placements, and maintain a low surface without isolated holes.**Trajectory evidence.**In episode 10, the agent cleared four lines. It selected 8 0 twice, with both its self-score and the environment reward equal to 1.0 on each move.**Outcome.**∆NABA = +14.42.**Takeaway.**The summary converts successful line clears into an executable look-ahead rule.
18
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX97QUwLcFGDXwxnIcP4awaUTknQ8LOoUk7f_mHJQpnO0bo9i-XIisPTZyjRLf6nwT45BVMExy17Q0QAB0LhCVK0Qn6sFI7SukZnNUBBqmTIsjdpwImaJHkwNj17JQgbB0RhDBBiPw=w325-h152-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8pfM3TdEA-EGGF5SM-nmpVtTEce4RTGDv489NNLTlP5q95oeSCqb8p8ZN1iYFJ9uRsbu0clVCSALKIBHRf10lLSs1Gk7FS98F9Lsu2qdP9OfKvWh0o7_3vmGJeGw1Z_gvXCKOVrw=w325-h177-v0?authuser=0)

Gemini-2.5-Flash / Minesweeper
**Summary direction.**Apply local number constraints: expand zero regions, flag forced mines, and uncover cells that are provably safe.**Trajectory evidence.**The agent selected flag (2,2) on a partially revealed board and received a reward of 0.0625.**Outcome.**∆NABA = +25.49.**Takeaway.**Summaries help when they express local reasoning as executable constraint rules.
Gemini-3.5-Flash / Nullify
**Summary direction.**Plan backward to create exact opposites, use floor or ceiling operations to remove decimals, and track index changes after every merge.**Trajectory evidence.**With terminal units -19 and 19, the agent selected 0 1 and received a reward of 1.0.**Outcome.**∆NABA = +8.50.**Takeaway.**The summary succeeds because it specifies a concrete arithmetic planning procedure.
**Failure summaries**
GPT-5.5 / PvZ
**Summary direction.**Prioritize sun production, early defense, Wall-nut stalling, and coverage of threatened lanes.**Trajectory evidence.**The agent opened with X 1 0 and received a reward of 1.0, but its later strict score fell from 38.67 to 32.33.**Outcome.**∆NABA = −2.56.**Takeaway.**The advice is reasonable but too coarse to capture lane timing, current zombie positions, and the available sun budget.
Gemini-3.5-Flash / Chess
**Summary direction.**Track the movement rule of every piece and verify all coordinates before submitting the answer.**Trajectory evidence.**In a low-scoring episode, the model produced END and received zero total reward despite having generated a detailed rule summary.**Outcome.**∆NABA = −33.27.**Takeaway.**A high-level reminder does not resolve the exact multi-piece localization problem.
GPT-4.1 / Minesweeper
**Summary direction.**Begin from corners, expand zero regions, flag only certain mines, and stop when no safe progress is available.**Trajectory evidence.**The agent selected uncover (8,0) after exhausting its available lives, and the subsequent checkpoint score fell from 0.0606 to 0.**Outcome.**∆NABA = −22.09.**Takeaway.**Generic heuristics do not substitute for exact constraint propagation.
GPT-4o / Snake
**Summary direction.**Move toward food while avoiding walls, obstacles, the snake body, and direct reversals.**Trajectory evidence.**Given a board containing food, obstacles, and its own body, the agent selected DOWN; it received no reward, and the strict score fell from 1.0 to 0.**Outcome.**∆NABA = −22.00.**Takeaway.**The summary omits the precise geometry required for safe navigation.
...
19
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9texsgenKmOAijqkFrkr19GkXf2a-W7wCMIoFQpAbZPamdrAA3Jb8Z2vpKgKBnyOgsA1U5igrx0FvDnIze76dTlsu8VvwdSE_pFnuU4I4slhQbznczyL08d4xj4e3mkiFd8p1ikg=w325-h152-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_i4ya2J-T9sW7WAKfCEimvJ08Wbovjv1fV_fj_Ia3nk_3YSDs3o9cH4BX8QEjFax5hn-EX0zSi3wv5evaVyhH71HoDppLTppyxsYsht-fsCk56TPeuGE3smjkoIcyYhK9YTK1_8Q=w325-h152-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_rVUN-Bx9H6tBa1v6UyV9rrY1X3_QvVSiexGx6ALxP6Zer7dT-A_6vldGapUAObvr-yXiGvhJJGr7Jm82e0r5FMhySimxkBIb79y_BGdgTulGSzscdAsC_PJtbLt1tG_0lcI53Ug=w325-h166-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_Ffy_f143wo72pbZLOM5B0Anrgj0790dt3Mxe6Aql0HV79nS12vXiM8Gi8oKpxgjfmDfS7wWwTOCaHczVZd7NvdlooroAg_1B2db9wIwFh-QPE9QgdnPpGXjdeUDpvFHtTDYKP_w=w325-h166-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_i3XhUJ_QvEHaT4pRRXvC0eU9I4ubAeri1oyL73UN0tNsINd2VrfB-iy8X0d2AD65UnfJu4NKsJN77r2zk28cIzuoBWsz_Un3kW7RFvdvLu9NZiQRfycIimQH1SF7w7-rljua3-A=w325-h166-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_gHS0IBu-tWHnVMY6O6pxkYSTlsCIX_O5sDokWKYC6jMljZu2E93Yz1osx93HBNjcZXSa2qGLypWARmsK-Q6aZ3tek-cm3kjcD6Py3IPTGPFKep2y3jGSDTo-bMcaT1oDV6h5T=w325-h152-v0?authuser=0)
...
[26] Noah Shinn, Federico Cassano, Ashwin Gopinath, Karthik Narasimhan, and Shunyu Yao. Reflexion: Lan-guage agents with verbal reinforcement learning. In Advances in Neural Information Processing Systems, volume 36, pages 8634–8652, 2023. URL https://proceedings.neurips.cc/paper_files/paper/2023/hash/ 1b44b878bb782e6954cd888628510e90-Abstract-Conference.html.
...
21
[30] Guanzhi Wang, Yuqi Xie, Yunfan Jiang, Ajay Mandlekar, Chaowei Xiao, Yuke Zhu, Linxi Fan, and Anima Anand-kumar. Voyager: An open-ended embodied agent with large language models. arXiv preprint arXiv:2305.16291, 2023. URL https://arxiv.org/abs/2305.16291.
...
Hint Messages: <RAW HISTORY FROM PREVIOUS EPISODES>
Game history of current episode: <RAW HISTORY FROM EARLIER STEPS IN THIS EPISODE>
...
Rule: <GAME SYSTEM PROMPT>
History: <TRUNCATED RAW HISTORY FROM PREVIOUS EPISODES>
Please summarize practical experience and recommendations ... Tips: <BULLET-POINTED STRATEGY SUMMARY>
The extracted Tips are cached for the session and reused at later steps. The action-time input is then
Hint Messages: <SUMMARIZED TIPS>
<GAME SYSTEM PROMPT>
Game history of current episode: <RAW HISTORY FROM EARLIER STEPS IN THIS EPISODE>
<GAME SYSTEM PROMPT + CURRENT STEP PROMPT>
...
23
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_pTcR9Gm0gzxxAotA_vJWJarzdqCsEgjfbPITrk7g5dFXkdoXZTr2dRYwOOCDwCb31fIABg67gJ4-E70MW8D2GySnGZ6EWtLK2mjXNnm63UsLqUS6kOtbu8R7m0o41t3e4wbv27w=w663-h219-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8lrxtr83ZurXi1b7W1UdoMxZwbnOYw3Tw4EL950ISJ9sFaKfTVJsR71VUxFS-GsnEfgX52lYOj3YnjjAtwpyqi8tVXPxA2nfwCYnIasZvC5XSsSecwpbFVxG8TFG_2jIsxb0Df=w663-h373-v0?authuser=0)
...
Answer: <ACTION>, Score: <SELF-JUDGED SCORE>. If the agent determines that the episode has terminated, it returns Answer: END, Score: 0.
...
Chess N ×N board with labeled pieces and empty cells Coordinates for one or more labeled pieces
Minesweeper Partially revealed grid with numbers, flags, and unknown cells
uncover, flag, or unflag
Nullify Indexed list of signed values and arithmetic operators
Two unit indices
Tetris Fixed-cell board and next-block rendering Drop column and rotation angle Snake Grid containing walls, head, body, food, and ob-
stacles LEFT/RIGHT/UP/DOWN
Plants-vs-Zombies Battlefield, sun budget, plants, zombies, and turn state
Zero or more plant placements
...
**System instruction.**You are playing a step-by-step piece-position prediction game on an N ×N board. Empty cells are denoted by ., pieces are denoted by letters, coordinates are zero-based, and every piece follows its own hidden movement rule. Predict the next position of as many pieces as possible from the observed board-state sequence.**Dynamic state.**Current Game State: followed by <BOARD>.**Decision instruction.**Predict the next-step location of each recoverable piece. Use the syntax A:(x,y), b:(x,y), c:(x,y), .... The agent may return END when it elects to stop.
Answer: A:(<ROW>,<COL>), b:(<ROW>,<COL>), ..., Score: <SELF-JUDGED SCORE>.
Minesweeper
**System instruction.**You are playing Minesweeper on a <BOARD_ROWS> × <BOARD_COLS> board with <MINES> hidden mines. Unknown cells are ?, flags are F, revealed counts are 0–8, and revealed mines are X. Coordinates are zero-based. Win by uncovering every safe cell or correctly flagging every mine; the episode ends at <MAX_EPOCHS> or when a mine is uncovered, depending on the evaluation mode.**Dynamic state.**Current Game State: followed by the partially observed <BOARD>.**Decision instruction.**Choose exactly one of uncover (r,c), flag (r,c), or unflag (r,c). The score is the ratio of correctly flagged mines to the total number of mines.
Answer: uncover (<ROW>,<COL>), Score: <SELF-JUDGED SCORE>.
24
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_X7OaoNj0oj__n4uQLdti6jQtwWm233I41ADEWXZNVed967Xsfq0G6ClyyMN4DE1YGCMHwcFZmjQ-YvqFdNY4eeu0RRl6Srryea1KL7-NNYBMA1XEtMGiMg2vRv43p7lKq7U3ZgA=w663-h72-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_g4sGiWNvS1q7-BYUtUEmYjfFm7p1MQ4AMAR64RMCwYAIfui5c9hgapmcmDDojy7KIuyyJHdSX0eukzL5-Xu0OSs-GA6eFEw3nufcxsm0Y8xWKt6tpTKIgjZUHGywe3rO6tPU0=w663-h142-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_XTFfQzoJQWLAOd56-UtFBIjj7BVEjkLazlb2ZvKsAo8ZiSimbDllQhZ_k8kJc1aXu0yGUWczU4J4mUFf8Om92pyYMNWGhcVh63NP4RmCbFBZGZFDynIIj4ynLpCKB4CH_5xfD=w663-h155-v0?authuser=0)

**A.3 Symbolic and Spatial Planning**
Nullify
**System instruction.**The board contains indexed independent units. Signed numbers (+n or -n) can be combined with another unit; available operators include multiplication, division, square root, square, reciprocal, floor, and ceiling. Combining equal-magnitude values with opposite signs produces zero and removes both units. The objective is to eliminate all units, yielding a final value of zero.**Dynamic state.**Current game board: followed by one index,content pair per unit in <INDEXED UNITS>. Unit indices start at zero and are updated after each combination.**Decision instruction.**Select the two indices to combine on the current turn. A successful complete cancellation receives score 1; otherwise the terminal score is 0.
Answer: <INDEX I> <INDEX J>, Score: <SELF-JUDGED SCORE>.
Tetris
**System instruction.**You are playing simplified Tetris on a <BOARD_WIDTH> × <BOARD_HEIGHT> board. The board shows fixed blocks as * and empty cells as .; the next-block panel uses #. A placed block falls until obstructed, each completed row is cleared for one point, and the episode terminates when a falling block extends above the board.**Dynamic state.**Current Game State: <BOARD> and Next Block: <NEXT_BLOCK>.**Decision instruction.**Choose the one-based drop column of the block’s leftmost cell and a clockwise rotation in {0, 90, 180, 270}. The objective is to maximize cleared rows.
Answer: <DROP COLUMN> <ROTATION ANGLE>, Score: <SELF-JUDGED SCORE>.
**A.4 Reactive Control and Strategic Interaction**
Snake
**System instruction.**You control a snake on a <GRID_WIDTH> × <GRID_HEIGHT> grid. Walls are #, the head is H, body cells are S, apples are A, and obstacles are X. Eating an apple increases both length and score by one. A wall, self, obstacle, or invalid-action collision terminates the game under strict rules. The snake cannot reverse direction and the episode is capped at <MAX_STEPS>.**Dynamic state.**Current Game State: followed by <BOARD> and the current movement direction.**Decision instruction.**Choose exactly one next movement from LEFT, RIGHT, UP, or DOWN.
Answer: <LEFT|RIGHT|UP|DOWN>, Score: <SELF-JUDGED SCORE>.
Plants-vs-Zombies
**System instruction.**You are playing simplified Plants-vs-Zombies on a <ROWS> × <COLS> grid. Each turn gains at least 25 sun; zombies spawn every five turns and move left, becoming stronger over time. Available plants are Sunflower (X), Peashooter (W), Three-Line Shooter (S), Wall-nut (J), Torch Stump (H), and Fire Chili (F), each with the costs and effects specified in the system prompt. The score increases by one per survived turn; the game ends when a zombie reaches column −1 or after <MAX_STEPS>.**Dynamic state.**Current Game State: followed by <BATTLEFIELD>, including the turn, sun budget, plant layout, and zombie states.**Decision instruction.**Place zero or more plants for the next turn. Each placement is PlantType Row Col; multiple placements are separated by semicolons. Rows and columns are zero-based, and an empty action is allowed.
Answer: X <ROW> <COL>; W <ROW> <COL>, Score: <SELF-JUDGED SCORE>.
Trust Evolution
**System instruction.**You play a fixed-length repeated interaction against an opponent with a stable within-episode strategy. The two actions are collaborate and cheat. Payoffs to the agent are +2 for mutual collaboration, −1 for collaborating against cheating, +3 for cheating against collaboration, and 0 for mutual cheating.**Dynamic state.**Current Game State: followed by <ROUND AND INTERACTION HISTORY> for an episode of <MAX_STEPS> rounds.**Decision instruction.**Infer the opponent’s behavior from the observed interaction and select exactly one action for the next round.
Answer: <collaborate|cheat>, Score: <SELF-JUDGED SCORE>.
25
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-dB1kGDDbdx-P1Z0hgWHn19VhdTn3QjmYygP6XpSSBtg_FZgZiNInHo7CYQys1jqhJ_LfFbBqOwnfb415_1zWNsCpTLpwIUAJg-E6Yeow7XIoHckRKq0sloppEu0Qjhu6f1u7cbw=w663-h168-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-oqFloQaOhNfy8ro86Zu-D0h9EBMiOBt7c8i4hjDOkaNVZSM0DvCFGFrMP2zZsxznnl7xinjQlbl4u6vJ3jRS8ww7HzlZZ7lwzTdAQfWRbsMxfBw6qNDU3UD8V-Q2dewcwFuO__Q=w663-h139-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_dDOHmZVKLdJ6S3vv3qj_X1f6DJVd9THcDCIQYYE3RUisZyTUHiFCPnfUDtkuzKno1QJYR2kia-uBGIWvCHBKwRoIMuDycY8hXFKlx6GeorfQHIvC9CgvEqQZthRY5nQe4xYeRdg=w663-h140-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8Xe2fSDaDaA6y5OCvjf2EqE-iib-4TkvghFxh74RqXse4nWhuqShDKtTlc76tOF67Vi1L2NpicXUyuqZPi8kbhVwebACGBVffsGDKQbXpg0dT5-Egrmm8KJbqVKcAkDCyeJDXQ=w663-h179-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_wmLgV9F5U08TYFHna0ngVbmHWrJc0Dg5vUGTY7hgMxJjsTGiOEihja_kckFIVKiO1AJSTsYj9Z_Z8-pf_xOTO_Puh9sogC9IhiGCMvI2F7BJc6ctRDHFbjCtVIhnX5GQPyCmV=w663-h151-v0?authuser=0)
