...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-I59_vBK09bD0jbwqCqYOk1h3_pJo9AH18hr5RnOq9QHAiuOh7RO1A50AhkEVHJcmSYOdgdg7oCFnZuVNYF4_8QScYApakZP5kTIl87u8CublAJWmY4WJnqrOmig0OZytbWnbeNQ=w1280-h513-v0?authuser=0)

### On the Scaling of PEFT: TowardsMillion Personal Models of Trillion Parameters
Mind Lab
Parameter-efficient fine-tuning (PEFT) is usually evaluated as a cheaper alternative to full fine-tuning. This paper studies a broader possibility: whether small trainable adapters can serve as persistent local state on top of strong shared foundation models. In this view, a base model supplies common competence, while adapters may carry part of an instance-specific behavioral state, such as preferences, skills, tool habits, or memory-like updates. This framing is deliberately bounded: PEFT does not store the whole person or replace retrieval, but it may provide a compact unit of adaptive state that can be trained, evaluated, served, and composed at population scale. We study this possibility through three coupled scaling problems that must reinforce one another. ScaleUp asks whether a stronger shared base model makes small local updates more useful. We study large-prior LoRA reinforcement learning, routing-aware correction, and training–serving consistency at trillion-scale MoE. ScaleDown asks how small the local adaptive state can become while still learning reliably. We analyze rank regimes, low-rank instability, RL-native initialization, hyperparameter transfer, and memory-oriented adapter designs such as δ-mem. ScaleOut asks what becomes possible when many persistent adapted instances coexist. We examine LoRA memory capacity, context-to-parameter learning, per-user adapter simulation, and diversity-based majority voting. MinT (Mind Lab, 2026) provides one concrete infrastructure example for supporting all three axes: adapter identity, policy revision, training provenance, evaluation, and serving residency are the mechanisms that let large shared priors, small local adapters, and large adapter populations coexist. Taken together, these results suggest that PEFT is more than a budget-conscious substitute for full fine-tuning. A personal model built on a strong shared prior can preserve continuity across repeated interaction, serve as a stable user simulator for agents that treat the user as part of their environment, and contribute to collective performance through diversity-based aggregation. The broader ambition is a world where strong foundation models support not one universal assistant, but millions of persistent personal ones.
#Correspondence: contact@mindlab.ltd zDate: May 2026
1 Introduction
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-Fon9GOdqDh1FIFi1ylO0QmYxnEb0dpdg5vrsHSHCq0J5U32ZtRH_INovNPkoJ9of2M3d5lKXnDzeJoGgEq2XRfFVDprW_BFGNpaIh5_6u8WZcml6ZDe8QJlFgp_197EmhG1M8=w663-h699-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9USN4y__yj1eZ5cfVlNEEvOeP1RlacDaNqWSkrZ7Na85M9NZXcLejgI5OjLoAsN-EFu191EoeYUnjD4srFnGsGfwhnsz5f08lmnJ6NgrywUe1YLfrdGLd8IF8HDT1C_b4iEf44bQ=w1280-h837-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-DJUJ4IpDsfgRT2L66XQ0KwTuYscxUwFOVy7nXSWvl9bI5auY8GPtO6nHkaw1l4Wv4V2itbpS6ewbTipbXk903QH0dJxFy7O7QT1bG5_EreO3g_0uGl5EDKAldOcJIcwdtKyoipg=w1280-h837-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9tqIZcfIS6CYFslDHzaYith30Bza4vVDeCZ30VCh0Egu3jgs1QfuBOjCUasQu3W6MnRLMwzGBhFWbnaK8wlgbhcvQ3P9Aas8Qzzyw0LSg_Id0AzPyFkC67HX6Qt7L--umA62vCrA=w1280-h837-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-5oktpfCTfSehn6XBEiWhOyxnzVKHiszs28Qb1K4b41Z8HuPqKqt-yd0TNSOlziCQ74Dq7XS9vgQ_YRemdZL94lXd3pmvfGuHODogRU5yB1kbdw_zbI1vqKFHaZ3h0vUn6Mw1tXw=w1024-h889-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9BQwIuhECFNryyC47txxQTZUxHJd0uwa9mHhZ46IKU15EBqqQ7Q2UxR8ZUD02OKV6tQIgdgmiiZwgJRn-226sQR9uXPVv1WsMGtYr8VuTA20C7_a3PqGM0Ev98Jofzy3nbs_k8=w1024-h545-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8gb1vYegqJjwbHbTpYTgWMK89u3ePJmSQLwYqGPlddcy0eyY6vepN2JbYuaVAslNm9lI7APYkTak7Tp0ZQSQfZNC13gQS27Ibg67KPq_GM01XksjRlnxkaOv3ShprmGH7TbxP_=w958-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9en3iWAw0dFEgvglEPbqOxV0ow5tDmrizTuT5ZNT-ijG18ZH16jaXZW9zgNN2BKbt9PD9UINIZ5F_vNq7qAXyu48rvORNOpZm83DnyzxgguSDJ89YR0uUtRpnmYCzReSGL8Ok1=w1024-h711-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_K9fZAZoRPkTsjOg7zKcR8mhQdfzUsgeSwqwOUHGXyPhwXCKMEl3xsqY2JxaWRXU6W9v75kE-_F7OS4kRUobY6KQwJ3hKJXxrlZoN0lCNMgGfcU372pDoNFMdlmn9PC9X9cj-C=w373-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_98PukO06AC_HTEG9H_QLX-p1YsDGP7WDxlviEk38Dv1tdZUgXvatQuY5IB_TK3e-ZCGf5PUYy0wWgCK3FJ4dAS_xbuOqqvCgH6ORCj-kPyugf-lt9dhqzpdyJaFHXvO24gH_wGQ=w373-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_nCX-ZawW80NZxt0Yerwsjc2iQMJeNdaY6Jq-WPne6kJjOE1nsnJVdflc20kqxt4o9S4nyE4fFU18nbJ7nOHVEpIzenNypTcGOSno6V_wTo4KrGPHDUg-fIqYetkOzYZTLxYWo3g=w508-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_jWjdAcHWCzN0blBi2crLJHvUtt6GW8_vW6jibCihovI6zMzOOHookO9GG_e50pirq4Nf_uj-bvlBRlJUnDBYmaFc8HIIllIXHglmHQJshVFAHBl21TwpuUppw58r1584fmWL4jg=w715-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-fLTjRBrGUOmR43iuijD8a1f4l8Kae_V_uTzpkYueJ-09MerJoMXEZEQDTUiQcvsWO9j2nyDJG44YdDsCyUoRGNnmwTRYSFggtoYfntnLtkkk3-5yqkJ0isV6geK1vqFpseBdv=w1280-h837-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX98v5btVUiiyJ6OIgkQuABZc7hl75X0Hq980X0WfNiM_NGaAUDc3tq0X8UZ2naYqTDU6nlvfS5sycdTL4XEqvYdkeCIkDTZax-Fa5v6K7fPmiSjD-wV_wkNsuXptAMwXn4d1-ZkYw=w1280-h837-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-s23k7ejf3NdFOCRm2UqH_-8Dx2ODaO8xybvM-cH6xgcQ0qLo3_0u_l9kl8Qk8Yql90XYQRHgxxVglNoc6rI1y_0aRNjDjhh3WAouEg2_GV_O5pNfUaic97DY5ISurfYbmgorHLQ=w1280-h837-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8w2PB02CtZr8M6AuXYgugVPV6t5_Mey4I2gQ3dfBwVV_XIePh-X6ac-Wqcxyol4JqGvXF4vh57Zyp0S9xloOGLqz8ZnnjD31BawRbJTKdkzC1EMahHkPoK6mojCWnHCSVD31_5zQ=w1024-h889-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_eLNxgoMe2rHpH68_hCvZq1ZWi0-l4hOgc-AAYOoildXhY78gueGAoa-TtN9vGPfZiFxod_mzPBpYceqGK1Hm9b6-WghGcEQXWoWyCNQPQib2fLptz1_WmZtYMHslW4d5GESDy=w516-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_MDouAPu7hP0hdrnQjKu9ZXkTnkJxXNm2jzJRGX8L7ZC_X1xdkxB4xGg9sbNcQyouWO5U_BQpdrOip7p344-rW3LQan2UYCRg7UuPw1uDGghkovWLNdFzxTzc50cvxGlzg1QNQdg=w516-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_wkbxfICcxBHkp1g_lDsBo2w4nY5Dv4ehBNusrms1q6jf745KcZSajZm-iU62PKbTNPKb0pibUArPTjxVl0IiFJtD1G_peAwbo9odHnz2TvLDUnnFTe5Zvzh7YJFeApRB-vw-3FA=w516-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX93CCSKVcHAxl4Gf9gNJfQXWwVhKlB1M0d1EmyGZmX7PuzSnnLRyrotp3ceaxI3XiIqA22GDdGgi54PeOxjXM4qbgJaLbfWLRtiBfoWIjVcCs_sb-NOezZdXWPrwy1i-GttPfyzWA=w957-h1024-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-53AYJKKKbE_tEjE9w86bmJJFkc1I1-LHjVbtgdgiW8cmu6-b-mB7ZL_fJ_11OvuPC11n1WaQlQsFmjaRH3OsUKFVkWzGtRAHVsv9pp9s7dG_waAo1LoeL3J1bR06grlmOOl3p=w973-h1024-v0?authuser=0)

### **H um**
### **an M**
### **od el**
**(b) Scale Down:**Shrink the adaptive state
**>99% shared human genome <1% individual variation**
**>99% shared base model weights <1% PEFT adapter weights**
**One shared biology, billions of persistent, individuated lives**
**One shared foundation model,  millions of persistent personal models**
**Larger foundation model enables broader capabilities**
**Richer genomic complexity enables broader capabilities**
**(a) Scale Up:**Strengthen the shared prior
**(c) Scale Out:**Sustain a persistent population
Shared Foundation
Model
～4B
～30B
~200B
1T+
Reasoning Code Vision Tool Use
Reasoning Language Perception Social
PEFT adapter
**X millions**of persistent
personal models
**… …**
Ratio of non-protein-coding genome
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_qI3qf0Yvu3T5PERhWKOQBKwQXABhPrOPQhNmmGUIBx7HitnkbuaNNHH8-JbRFb5jSJlHf5_prtAcNMR_FN6MKZPcSyzppg5GlMAKxoD-GYz0mn4fMCyX0l4ORoEN_awsMmRRFlw=w674-h443-v0?authuser=0)
...
Scale Up Increase the capability of the
shared prior. Makes small updates high leverage by
providing richer latent structure to adapt.
Scale Down Reduce the marginal cost and
instability of adaptation. Makes repeated learning, storage, and serving feasible for many instances.
Scale Out Increase the number and
diversity of persistent adapters. Enables personalization, population diversity,
...
3 Scale Up: ScalingModel Capacity for a Stronger Shared Prior
...
Table2 Large prior plus small LoRA update can outperform full RL on a smaller model under comparable RL budgets. Values are summarized from the motivating Mind Lab trillion-parameter LoRA RL study.
Model and adaptation Trainable parameters
AIME 2025 normalized gain
GPQA Diamond normalized gain
...
3.3 Operationalizing Trillion-Scale LoRARL
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-IAPQTbaJh8feQ5yZbKkGTuG2PB59j8AFsON9Pjk0cPWRd9PKgizhynI1mEfs8BOFKZ3QubY63odMoExGhWrUGF29NLSYDPIj_Qvw2VnTk7lXN1NKh3gWmUhMP57XZu_MxdWdfFA=w241-h34-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-H2CFWE1i0qJbWD7uTfCJy8zLOMOzOYO4nlpaieyJbj5yv_gslqFct6NC26XCwZbTUUPPrVjzeRiM-TKYIifctDAIeBZ4sQ8APdvl4P4bkt7Wrjk6EcQHzH9kGNmeSEXHR-6Ij=w113-h34-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9TyNMPTcCS_6JFiOo9GEAIR7KAG_Jz_WDYgv9RWn_IooRafERCAdTjgS_hRK5_bjq143Tzran6Jbz6rU6wsjTCG2Z9nBMHkQtQBe3eFlhqXqAk4FcrIeVKL_vaK1svuO5JLKSZlg=w121-h34-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-ziJ91DLCEg50skQ-lWtPs6FHBOfHuEXzxg49i_rCS8d-bRAEC4BmRNSUmNE-HHAgtuRkNw9YdBRXE2aPKiFZegiooi5ywtpNTww2wGQ8EriYU216HvxP7XOtC-bErrGWZ792BJw=w121-h34-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8g3ZB6mTrPPspZ7manld4eKQNhod5WlnzbGr6YrYVgV9OFQdq2Hfq0JhhZVaFSmCNef56RJiASylhraJnXC0nlb_soybZP7avigngs7UBvTxa2s1ug9i8QVpqWgFv-8A8CPkub8A=w1280-h416-v0?authuser=0)
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_7LultdJPagFM1CqAvvadBc3dwg34Bx3o1dwrNDyVdZOULAaGYLw5r8JbIHRdV3K6RTcxpZq9hhB4VWsjwrUhaVK3rLLTyqqj-L8ifv-_YCzILZpwivMcxDrwJRaKgasVwVKIA-w=w1280-h749-v0?authuser=0)
...
3.4 Scale-Induced FailureModes
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_kXE_ogPGUWdPcTyh3Vr1Ekk2_goO-5q3u5Plj2-wXy__PDFWIc7qFVhGSlNtlHZTSDP4u5mbW4OY36jVC8EvYIFWAT1rzhuEQ_Md7GWF3m6vjQrYYHi9SJxpjLzACOuYmic7XNw=w1280-h749-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_s8z9OCaXbJ5t4D2vBzz4mf6z6Kq1k3FVGeNtCJiGsmX_oz2VY4fjQzR2eO8B0kY-QYj9nU7glrtpWuVCpN6rIJvQy7Ad0NksWdXPkVscAwzUULF_zHXA9zG5AxhhpFNj5eQxd=w1280-h749-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9_goQicM7RI4n99mEip5r7iLD7kO0gjWu0BT2CitEzMwyDsnjHBsXod8WTau7615KUbt0embACIvsj9pFyzF4Z5-V_iPCifDorjNHJ4bg3TAh7E67J_eyiEo0-P4mMEkp6EnZEvg=w1280-h749-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9RTovIk-vlXLzppf6mDGWMfbhiR96gUwC2iNRdz__yDfgnjd0QQ6hWbm6nqSpQEaOtYvRJ9T9eBVgGfx1UScI00zMAX6E1_6OSQ4_K87V5rtPNyUWmXlAZ9dqeNDH3MPNKksFGrw=w1280-h749-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8yle_Zb8bQY2eDOvWPjleX5xw48eeSB0deNF7dNt9tua5Fh1qcV_w-ZQ2aGCnjrzrU9-Jkt-2q1MddCFOVHM37CNvEB2cJ28MUKxQayPH8OWSvAQihqcB_R8etuZkKPdF-tlNs=w1280-h749-v0?authuser=0)

(a) Maximum rollout probability difference per step. The original and rollout-corrected runs climb rapidly and remain high, whereas the R3-fixed run stays consistently lower.
(b) Standard deviation of rollout probability difference. R3 maintains lower variance throughout training.
(c) Mean rollout probability difference. R3 substantially reduces TIM relative to the baselines.
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_U9q0YjyLG3JDm-I1BaYBH9WGVppznTbFEs0uybjo6oR2KJRp2YTLZkXzrsxKUmEYWJSnDnyoGjD2F3oXKsNtaVmYk5Uqyl6G0sEYfARzjgkVCtNRsU0aBS3Z70sww3xNw6H7y=w1280-h749-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-0YDLhcstNuYnqqPBv78CED_wDxQt-2bFs8IiHKKTtYDWjrL7SsNkCQOnUF4oFipHDal9uKJUdVnUSkGtz0qKfI5lwLXA5jVRuTzpiRsQCN1fTH6lHLIrqnuGwFp76_q5G01U0XA=w1280-h749-v0?authuser=0)
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_cDYvCwICpas268bcFm_M1LJDDD81aQpSFpbRiE61lBXsBj0HdDpuqn7AcjVs0nKyDoq4xyRtVg1yFQZu2yzF4JKekksu_Me_brDEyx6Es9xVrtqT1tvIwVSV689DTGGPbKpj8Lg=w1280-h380-v0?authuser=0)
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-EwlYEF4lnKPkZqwvJRyNKUVhQZTuCPMBzIOPeQ77l_JRbEMX2MieN70nD8WzxlqFH97Yb-sQZyZ3a_293h6XQ-A1AlPzuaXiYcPsJii8pwoP-9FNnyVlqjRXrtIlaJ4wjJAuLuQ=w1280-h973-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8yHQN5gJSQJ1TVSn0h4e20rDc67d1VO8LoFKlcrFlmDTGA2n4wMwqfHKA7S7w-L1njFKH2acW1jFLfGGE073sQGPIU22mZ8y8AMRnG_m6mja1EPH5dQTvxzrwx3OkRbv6e0x7TpQ=w64-h1280-v0?authuser=0)

1 2 4 8 16 32 64 128 256 LoRA rank
−2
0
2
4
...
4.1.1 Rank Reduction UnderMinimal Parameters
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-821IhBSWeMPpsXzM6MDtOxDtr61eaVghacvAfW-is-HLlVZTaasm4vRCKwVL6RSboPLZFgF6vQ4QKdqccQd4Z9uL-XfIgwt29ACVCqDOehd5Gl6KwJkavHHt9dvTAyDhGw6Vesg=w219-h145-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9qIosF6sSjGBeMVIrKGBS-aQ3hhKe3-LCF68lye9BegpLpeRsHNWzrtPr5dR-4rfd5-sPC4GhK4zSMrEO_xB_vUB5eSSOUJvOWou7m7srgO6aBh4C3kAJehrsktlH7w7SAgEbMgA=w219-h147-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8WkwCjazEbWML7xwdMSBXK4Dv0MLJnvATlL_aIxqTL6ttHNl5221GBGrxJpGzyraEe4Ui-cRzc0MCbxmCf-oAqjFV5eG42empRQRdm8ddL19u5muJcVgNB25AD4MTP1pjm958JwQ=w219-h146-v0?authuser=0)
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_edFwVsa9A5LUzQsS1zoxQFfu5-Ya4yda4hZKXJaog8FsbzRCC8C9iPJrOiX20gxdvc8CVUsgI90z8XMMpIJYwnPhO6qwM9CsMDtaBOR7DJ0wG-gjZ9TN7Rb103wJ9kxEkeP3h5Q=w318-h214-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-LvOczE3GDrDe_JWNCHqt1tF1YQedsohDX-hDUzjjaQTWnAOCgTdD_cXV_Z-fIOgzj73KRNN9wi66Qozb_PszvnsK7aGIh682O0V4YLqTGGAMbd3Lt9ozWKcV_JrPy5KnvJdcf2w=w318-h214-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8YqOxL6MAN_e4-RPqha6OY7hWZmTpYQPEwGBIc_olkL53teOOdWSIMvtNSiEInpKqTBjoO9RbJm-pv511KLM9skMSO84rhVHEdFSdOVtf42NVeEXBAuXd2RZJkJdR7ghlRUkI3Vw=w318-h214-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX84dSlxrCuIXJwKdg2BKfcGdGrQA-xYEVlLAW_hEo8ss-DiCM0Dx4FI-heeyBSZ8Iyc8Qj-P59w2jn--TJZ83pZc6mZEet9gJnDEBQbo89x69aPvmeJHqWdL7C4jGDGXc-sAX0cYg=w318-h215-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-jV-eS_DWtOPCeMsicG7w_Zpq9Jl8rQl2a80pIzzwhwsTHcr-sakJPQSqvxwmxUgDH5709MQ71I-M54klephjgeB78ZcBiSOWaYqzOP3UzXjNdwhDxFw_ukxqfYrCHKO5Tu9mjIQ=w64-h1280-v0?authuser=0)
...
1x 2x 4x 8x 16x Adapter footprint relative to r=16
5
6
7
8
...
50 100 150 200 250 300 Training tokens per run (M)
6.00
6.25
6.50
6.75
...
n (p
p)
Positive seed Negative seed Mean +/- std.
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9QVg2rww6jV6OKYiFVkO7SkB9qExhvK836XGv9ckl4UJpCAcFAqaqWIyof4mOssi1n3O_3XR_bfu6PpSoCVO0VF6QE3jxCfdSovm8GOBdw8mFsQR0gVo1yD8zcjySki9QHgLFNqA=w318-h183-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_0kE8d3KR5arVkzGaZzU4UBUPw_1UTVzJyisNRGzEWWY7lO0Jx5XhTXyqGZlNQnVbWCOsDCsxz1YvYlwYpdy9F3ewnjytwiEM8S05RmlKDShHWVD-80lDrTxSCUqcA9qryP-FSJg=w318-h185-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8wqVb3ymtoApOmE3CtFKHI0x7kv4S5Wv-cYjCKjVg6ejam1hdPgaV2Q2L-mApQVZvfe7VB8HAMjtYS7FW-URliO39fvwX2GV3RZ96n7xqQKPmeIBFm47KQODdHxPbvCOfgtb6xrA=w318-h185-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9gSVfwS9ebxMZDFnX1rIo8nE3l1ADNouvOS8k396RF8nxutdCeMIDdCZbwsVpv6vU5SGLhOksTgwaU0_iZB3DacONBhxamzjio5ZIBguA12PZmPXn_VG5X5a4lU4SVQCfuXNWZmA=w318-h179-v0?authuser=0)
...
0.0625x 0.125x 0.25x 1x Footprint relative to r=16
0
2
4
6
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX84IpaEEupOhNrAdIj0KSSqpe1Vj5kDbPBANfLQj0c_qfuSTp8o7chNsxGIBW6iSWB3N-9cw3C6hh92qUZbREvsLWrvijLqiX6xjyGLksl8DWoID5bZMJRg309-c4GNJQRJPC_8=w318-h214-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_HqDN9lNHXWX6XWM1eCGdL6ZMUbUqyT1Wb58YBYtU_yC1kutcIlJ5k30XsYux3VCY5YSs10SlyaTjN1nu5BMkW_Z0h7c0qROhtSnUZeY7Zynmz8xoM4Zfa6dURlv17IFgfMd11Rw=w318-h215-v0?authuser=0)
...
The reason is easiest to see from the sequence-level objective. The RLVR objective can be written as J(θ) = Ex∼D, y∼πθ(·|x)[R(x, y)], where R(x, y) ∈ {0, 1} is assigned to a complete response. Since πθ(y | x) =∏T
t=1 πθ(yt | x, y<t), the REINFORCE gradient (Williams, 1992) distributes the sequence reward across token positions:
∇θJ(θ) = Ey∼πθ
[ R(x, y)
T∑ t=1
∇θ log πθ(yt | x, y<t)
] .
In deployed RL systems, responses are often sampled from an inference-side rollout policy µ, while updates are computed for πθ. This gives the importance-sampled form
∇θJ(θ) = Ey∼µ
[ R(x, y)
πθ(y | x) µ(y | x)
T∑ t=1
...
T∏ t=1
(1 + δt),
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-_UtWkuY8faCVMDeDo7S88Pmwf4osQM8hUCQ5c2Jylip1ryNIP2OHQD0ikMlu4SXUo57X6yBJwn4KXFSzS2Td3gURE2GIv9a-HuwnbJ_Zug3KLgJBauIW3A_HJFGl7E07VgnLXkA=w464-h271-v0?authuser=0)

where δt = rt−1. This product is exponentially unstable: if T = 512 and each rt = 1.01, the sequence weight is approximately 1.01512 ≈ 163. Practical token-level surrogates therefore depend on the first-order Taylor expansion
T∏ t=1
(1 + δt) = 1 +
T∑ t=1
δt +O(δ2),
...
If one update satisfies DKL(πθ+ ∥πθ) ≤ K and F (θ) ⪰ mI on the update subspace, then a block update obeys
∥∆W∥F ≤ √
2K
m
( 1 + o(1)
...
We instantiate this idea with OLoRA-tail. Let W0 = UΣV ⊤ be the singular value decomposition of a pretrained weight matrix, and let U−r and V−r denote the left and right singular vectors associated with the smallest r singular values. OLoRA-tail initializes
B0 = U−r, A0 = V ⊤ −r.
...
### GSM8K MATH500 AIME22 AIME23 AIME24 AIME25 Average0.0
### 0.2
### 0.4
### 0.6
### 0.8Ac cura cy
...
We train DeepSeek-R1-Distill-Qwen-1.5B with DAPO on the DAPO-Math-17k dataset for 500 steps, using a constant learning rate of 1× 10−5 and an effective batch size of 32. Both LoRA and OLoRA-tail are applied to all attention and MLP projection layers with rank r=16 and scaling factor α=32. We evaluate LoRA and OLoRA-tail on six mathematical reasoning benchmarks using DeepSeek-R1-Distill-Qwen-1.5B trained with DAPO. As shown in Figure 14, OLoRA-tail achieves a higher average accuracy of 58.3% compared to LoRA’s 56.3%, demonstrating that a better geometric initialization can provide an advantage.
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8PbyZiK2Otd_rPbBh_LCUDs8v_99-ZWk9_E9xDE3-QqzgEQISdhkIy4SURSyyCWrLl28GbAq_D6jHgqpsubqFMv-vmic_iKSmixspTQvvbmjUYdvtWEeIccp0g44U579fPfjqyAw=w663-h237-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_rm1mF_OL97ZIvn0R1RHUoyM8uIgptXG-UxQiGa5JrW9GTr0DZP8bY6h4PLyb1a57Cg3D7Hs6WsvDSNvTPeP0hT8CaxZx0RrfYtHnWsUC1cb6QV-e9UTQIqWA-OPda3hLZQsxKrw=w411-h204-v0?authuser=0)
...
LoRA OLoRA-tail
Figure 15 Rank-1 OLoRA-tail versus LoRA on Qwen3-8B and Qwen3-30B-A3B-Instruct trained with DAPO. Left: ∆Pass@1 over the base model across batch sizes on Qwen3-8B; OLoRA-tail maintains a consistent gain of ∼+20% regardless of batch size, while LoRA degrades from +15% at bs16 to −18% at bs128. Right: Average pass rate on Qwen3-30B-A3B-Instruct; OLoRA-tail (35.5%) surpasses LoRA (24.0%) by 11.5 percentage points. Error bars show standard deviation across 6 random seeds.
budget?
We evaluate OLoRA-tail at the extreme compression of rank r=1 across two model scales: Qwen3-8B and Qwen3-30B-A3B-Instruct, under the same experimental settings in Section Section 4.1.1
As shown in Figure 15, the results demonstrate that this distinction is substantial. On Qwen3-8B, OLoRA-tail delivers a consistent ∼+20% gain over the base model across all batch sizes, while standard LoRA degrades sharply with increasing batch size: from +15% at bs16 to −18% at bs128, with collapse risk reaching 67%. The geometric advantage of minor-subspace initialization does not merely narrow the performance gap, but it eliminates the sensitivity to batch size entirely. On Qwen3-30B-A3B-Instruct, OLoRA-tail achieves an average pass rate of 35.5%±1.6%, surpassing the LoRA baseline of 24.0% by 11.5 percentage points (+48% relative).
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_7L_Y_R5GVDBf38zl0hunEoHmRp5cltVGLTck28gNBZu0uJZKklSobST7cAl0nfEOZJ2nFPIC_KShwoNhS11cpmoYdQ4oucccIRdhAO7f16RcrQ1CP7TdntbrHIgS0Gc--29vBSA=w597-h334-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-Ek9tHmAJh83ccUD3gb2ssSaWF8HHM-7wHE6oXIyW46UTfNjPypk3MdZUMF3pbU_j1_ILspkj4y5xtUz5iwxc0Nd0ib2fmYmxnNn4ou7Xalb5PDkyAe-gRA91A0C2Co8TE4CK7_w=w1280-h388-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8KwD5egvRRdC1VCmRtjy-F7lydV8CRGquScipDZZhnq-SRJbNmenvVE22ED6Q2o6m6iCtCVavPYTjEuQ1Vg5ZKaVNTB0qKzZW6jAf_qXcWuXXkGnIomiCzpBibtEZPJC-gkj1drw=w1280-h454-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-GrCO_Dbp3arBn_9dlMIScJSYFqEI8Xf_DJF_bAtK8OMjDk_qnNCOZODHbetDNwhq_iGnmKoD_1kozouu3XY64uWskyosL_iJTTQ92nV64z4jx0vyz735I214beQR4BIMwnhf0=w1280-h427-v0?authuser=0)
...
∆W = αr
r BA. (1)
Under standard initialization, A is random and B = 0, so the first effective movement comes from updating B. With learning rate η, the first update to B scales as ηαr/r, and substituting that back into ∆W yields an early-step perturbation proportional to
η α2 r
r . (2)
Although this expression does not fully characterize AdamW dynamics, it captures the leading dependence of early update magnitude on rank and scaling convention. If α/r is fixed, then αr ∝ r and the effective update grows with rank, so higher rank should push the search toward smaller learning rates. If α is fixed, the effective update shrinks with rank, so higher rank does not force a smaller learning rate. If α ∝
√ r, rank
dependence cancels, yielding the simplest theoretical path to same-order learning-rate reuse.
Empirical sweeps show the same split. On AG News (Zhang et al., 2015) with DistilBERT (Sanh et al., 2020), ranks 2 through 256 were tested under constant α = 32, fixed α/r = 1, and α ∝
√ r with α/
√ r = 8.
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8H0QZV7RC27r8hDgnok2lPDkwdVNLNcKSlUFMCwVMxULB6HtVtN4U0tysjrnarYMB078tog2Z9dsC-eTC-jblh7yJLUR9336hP0beVRcYWhlg4Md6qqgcLH-GQB1xzGvTKEqefYw=w1280-h832-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_QicpUcRykILeK1Lcjws6tYhjSH5kYifbqbNxzPvE0ANIURZjsDs9FMKeOGMqf9zyU2SntwlKXTmvoU8dJAmURYLQI_E4ucrHTlAaPCO8ZLQmboArEn_RCjTpxo13BilEpmG3Rgg=w1280-h733-v0?authuser=0)
...
For population-scale PEFT, the practical object is not one magic learning rate but a reusable band. Fixed α/r pushes the band downward with rank, constant α often keeps it flatter, and α ∝
√ r preserves same-
order reuse while remaining stronger in the harder reasoning setting. A world with millions of adapters is impossible if every new adapter requires a full hyperparameter sweep. Reusable bands and rank-stable parameterizations are therefore not conveniences. They are prerequisites for adapter populations.
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_9PQN31foFIV4me5FS5x7lGm6RVtp88NV8PnJmlDlLVQopJ5jy4vD62-5xaCgC0ABiZehqTzu3sed3HLShEHyto0U_CtqC3SH4X5jnrth9yQ7RVVPGR0pIvHeF4JFwDoXO-JbmiQ=w72-h72-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX96DQY74Y8LD0ZmF5fiQn-aS-oiWNQjLIWY3S1u_tBesk3bPrkbhDOEDYJXvBbLM5zldyuvNNaB_zmcavRDeQ-IgN1JaTeGxK4vyhZizfvKpJR9I4VO01PYZHZXTt_I53_AwP33=w173-h172-v0?authuser=0)
...
# 𝑟𝑡**Read**
# **Concat**
# **Writing Granularityδ-MemLLM Backbone**
# 𝑘!	𝑣!
# **Attention Computation**𝑆𝑡!"
# 𝑆𝑡−1
# ... ...
# 𝑆𝑡
# Updated over time
...
St ∈ Rr×r,
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_mJg6Yv7Trv8alUh5x52usFe8TsxDednuWx-TklHjr1_UgdpF3LlTnpoDr2dpt3zZvgZ62Rd2Bdv7-g_5VAtNHUvwx3tJk6Hi2OI7D4v0FC9k5UATC0GekDmSAjZCxEEKB34-ztg=w630-h304-v0?authuser=0)
...
Model IFEval HotpotQA
GPQA-D Memory Agent Bench LoCoMo
Avg. EM F1 Avg. AR TTL LRU SF Avg. Multi Temp Open Single
Qwen3-4B-Instruct 81.89 42.35 56.00 39.39 29.54 35.30 26.14 47.08 14.37 40.79 38.39 32.89 10.77 48.05 46.79
Textual Memory + BM25 RAG – 40.35 52.83 – 24.49 32.20 9.74 37.86 15.00 36.68 38.12 20.34 9.99 45.47 44.56
+ LLMLingua-2 – 36.93 50.03 – 15.63 21.45 1.43 38.45 8.62 40.98 39.07 30.13 10.98 49.19 42.96 + MemoryBank – – – – 17.65 22.65 7.67 36.36 9.88 38.14 37.88 21.76 13.35 47.31 43.88
Parametric Memory + Context2LoRA 76.71 37.85 50.88 29.29 32.53 40.00 29.86 25.15 17.75 48.11 37.95 34.99 16.75 60.11 44.90
+ MemGen 39.37 5.36 16.27 38.89 29.61 34.85 28.45 44.30 14.38 40.05 32.93 33.30 12.67 48.13 30.66
Outside-channel Memory + MLP Memory 24.95 10.94 25.83 22.73 28.80 35.35 26.00 31.19 14.38 26.85 32.87 16.72 8.81 30.75 22.85
δ-Mem + δ-Mem (SSW) 81.70 49.22 63.43 41.41 37.84 41.50 50.50 43.02 16.50 47.05 41.00 36.48 14.08 56.88 51.44 + δ-Mem (TSW) 82.99 49.41 63.66 40.40 36.48 42.45 40.64 46.08 15.88 46.53 42.14 37.20 13.35 55.36 51.66 + δ-Mem (MSW) 81.52 46.86 60.47 37.37 38.85 44.40 47.29 41.55 17.00 49.12 42.57 39.31 18.12 58.59 50.74
which stores key–value associations in the adapter space. Given a memory key km t and value vm
t , the update can be written as
St = Diag(λt)St−1 +Diag(βt) (v m t − St−1k
m t ) (km
t )⊤.
Here λt controls retention and βt controls write strength. The important point is that the state writes the prediction residual rather than simply accumulating all new information. Already predictable associations induce small updates, while novel or mispredicted associations modify the state. In this sense, δ-mem preserves the low-rank steering interface of LoRA, but replaces a static parameter patch with a historyconditioned correction.
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-mG5xOA86QaMnjTjSctT5cLWxglQZDgyYhFj2isbjXvRaaalMRib67bLkvvuQBXKLNYxmfMY_6_zBbvcJepM7dnLM2JoL2gm8qFeS0heBUaoY8JAo_pzFN2bBTOl3_mH7kitRePA=w128-h128-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-ta6PJVvgzGn7zNthzJ9pWV95KWfUCO1vUIoEBk2R_YP7laz2lDn3IszwjLM2vXCO6CREAlM2g1Uq6nwG70UJvJhqndejzlUOr478L6gi24aWJ_CvAPqf3ZvT9P7skG4j2IX-Z=w128-h128-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_x8CbOmG7mI7X1tNmOZBjsJrfcA3kE3zuYPF3cGSi2Qc9dU_Zz_Pj-QGYhJprtBtSgZdPgFAWLzCkcRivfXztuAkZMxB40PzAFKlTZG49_xGVfiwRVi3pgg6GdX08eoIHMwr3t=w128-h128-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8mmDzmJsnQwWjyOUT7eHAdqgATkQxojMRDiJZh4klfMmm8f4t3ia7aFte1p5Ekg9ZdbW1BldFhXCfA_uRDG5SaCsIxB0YAKRNut9A4n2GivgvEOmHXLT5nw3GgLr2-ERv9XpHj=w128-h128-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX94s4wd6yNMww5kEKxQ2DJZESUvgBJfrPGwA3-T8gT_t5hQgcVrc33DoguoS1InOHPh91d9uDerkFQShD9BCtpaIKWjjUsFp8Lw8yN-eqBlFFTRoxxt8bhhXbwOs9G0H3MwLjzw=w128-h128-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9V1Ygrdx5a5DYo0LzzobUATMpLO3nf5KiLc4cf9nekVc2DJ_1qNTrifoJ6zd7hQWI64Vz1v1WAWD4GRpUPEo0VjKmCc1y1JJlmqogQtLVWX6zYvsmlm-6MkiUFeeZccYmgP3c2=w128-h128-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_qD6Wr7NNH7-SsZDCHvRKJ2za6HYH0He95jAuDd_bHsTUVJypVQJ6P2PX1YDPQA42BDjbjK3dmf06esDnUpjMbGU-2c9mUUQrtVrsw2woml2fqXfE4K9QXAchbm3GjEH8IboQI-g=w128-h99-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8bqeYYCewZCOZm0ahAyee5lbXfOh_IZ--lLsx-KxFy3gqFemOPHj5Ag7lvHQjRftkqBQHRfB5rTHn00EwsvKM-ZO8wSpaB7ZG_0-0NCD9pVnXZRwIyFtARWs-6kwjSTcsutsZN=w128-h116-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9Px8kToPNTvv_p81U7CRbgDofOs7J1BoHLu4zLq1nGU90hhYfEEvcAfkx3CiYD1TA8VxmDkD25nUgMd2E4L__UMyGMugn2XEnizQsX8J8G98HsJCmljpJDh-h5ZvEobMdodjjW8g=w106-h106-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_sIcU4xYhxYKCHO33xfDyUJI_d0ZWGIMgvmUWYnBsrKacu_1u8W4fg0_dawTOcYJf6WMkQV98jkE_0qDaLycU59Qm8ieBBxRxYv6f0G0E5R-SPafOqO_YV2MBUMydtEZOl7JDc4g=w106-h106-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9tleeogJQeznNCHhr6eA8bdqcOc4kyYP5TtSghNRKcO0XM4GTAkLHBfz-zMPB7RCpT3BLMpid2ZMxCCJFEOOrLaYMS0md6gyPbhb5E487ErEIeYX4ygJQVeF4fvfn7l6Vap9T-0A=w106-h106-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9X6rt5qQAzo_ZOS0DKCLvSvSg5luWhrW5XRHJx6iURlqpU7yEOADeYwvgXZPySyriAXL6fDU7Lr6Ox2u76t--Nyeia6Ud36npsIxyfCDVjH9R6VLBkemU9LbhaCRyMUuDYt-Vknw=w106-h106-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9YLLkdMiiWYyWwOgtgNeDggv4lPXfWMGhmO2FVoSeCV1-cbBGDDbOswXPo9i-7HzPET64pt1QxmssBb4Kx8O_tuQXX66C0qEbZUTLdUtOZX0oLMuRryHA-j-Nnq5OitRuONDow=w516-h208-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9tyZnLuJJQrOHohyOUKhU7_sssTlnux0hA_ZOPuhgQizBTLykdYvS04vuJUTc8vTyoKMrk-o86OahlI83t_NOt2TN9nr-d_AcT7iKz4iDvT-Bb4KtOk0sAsVB_zczIevp7WVjMkw=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-IBxpOUmMcXEL1cbQk-KmRQxONDWOPBZnrkvZnFzQwm5r9CIcfqu2FGB2rHK_MGtK2D8-IWzNkT8K2X9cuNHpUbsIvWfDXdt-1MJqS0dOsq3JLJppRBobAcq-EcmsHM1IbmqvJ=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_wdEt1ySUxJ7nhBslbb1Wqiz-Rhac48LfeoPA1hwa_sZrDMSNx7Ml-Ktl0ftx-yM5qfPUjLArLfim2xYvHTDlMKC1MjYb8EEfjtYly5HdFPToMkKl_jDKqXrmQMet2Z4N4ot51Yw=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9BVhZS4GqFQH4d8BfYhFq6CG55oKBrw_vn954cNlmbqeCMGYJwlTBBSbel255NssdAM-GfJtB950WMc4q8KmdEADr0Gw_NkgKzBMGMZCK5ScwzLL2zMTYfrup560ppalGEdu4d8A=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8pjnFbd_blE22CAB9sZA3QQBoIGPgk7a-AuanbkR4D7YPsIztPKiKRFFEXlOGZiit8bPFzCenpo0imU6rnvcINQI7jODYuB6bTVuOfLvxVFCVNVamtv-a_k6mgsmo1Wg7e5km-Ag=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-da6ra6bEgz6S7svvhtiYhfqz5y72qVZ3kaJ7YXDPYA1zToWTTsKVss1vUcXBKx7SUZAEVE9GFRwgLWJWHmMsUTeWGcc1ojg4S8EOnIo0pbn7lGx7eZighZXrN7i6P1wTjqyx6=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8Ron3CU5ozu-Qo5qso26DYX0kQw_07l7e4Sm8So2bItUkZ1Yy9HNzKdUMPQM5gW1ZeKGm24gloG9Z8LRjB8FfoWb7wMIuN3WF_QriCBh5DvGnrsQ4tZOztP7va_p3iSUGvbd2KUg=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-PJqsXLnDhDCybS-xDksekXUkTJ6oaX9cYumEDtFx5L6kSVeWzUhoRVQcI2j-AwJUUwVfC0DDuUkbj3rSKzvoCmFI_DFdbh39bi91-p83xn7FSFx7a9F1klHaByZb7fJIqM8Ea=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9S1RcJcmodI0rNtdjhaCFY-hmJdGJ1kD52LpfgMZqGm8j0LYfO88XY_BtK2AQzDoYbVoiPDAsObfmn2IomO1No0c3BSOvg1ZUXVl5as9XZCPcD06kta0caP7CR9CNuLeNJ60VOPA=w108-h108-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8ne44T_u9GkYNK7Tww9TUcp1OsMNM-KtcjNGH-HkSlrlqvQUugMUGR_qf1eocGZKx06e-Ml0FucgSOTjm4by7AMIG7Ddb4KtA9XEmiiXrZhcpBQk7augYnNC79bHc84HdJnMM-mw=w108-h108-v0?authuser=0)

Shared Foundation
Model
PEFT Adapter
### **Persistent personal models from tiny PEFT variation**
### **Personality Problem Population Problem**
+ tiny PEFT adapter
(< 1% local state)
*One shared base. Many tiny adapters. Persistent personal models.*
*How one adapter becomes a persistent individual*
*How many persistent individuals form an interaction world*
**Personality as Policy**
**Personality as Environment**
**Memory Skills Preferences Tools**
**Persistent Actors**
**Interaction World**
**Social Simulation**
**Communities/ Polarization**
**Simulation**
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX80FItHdIsOE4BdJ0m8uOPsbw5om-SNIFzLHX_SxXYMXwBMC1N_Y1Pt1XHxbaC5uKZMSy6aCY7SZ-IhuyZ5OxYJ4U2MQ1hxQB5Guk5LHtTDZ0pDdAMovLbEnDe-T-pSYrPfHzSkFw=w667-h375-v0?authuser=0)
...
ra cy
**transition zone**
A. Capacity law (n=263) transition: 10 3--10 2
binned median transition 10 3 10 2
1k 2k 4k 8k 16 k
32 k
64 k
12 8k
...
ac cu
ra cy
B. Rank ablation: MLP (n=99) rank shifts the boundary
rank r=1 r=2 r=4
r=8 r=16 r=32
10 5 10 4 10 3 10 2 10 1 100
tokens / trainable params
...
ac cu
ra cy
C. Module ablation MLP LoRA is most efficient
modules mlp (n=99) attn (n=43) mlp+attn (n=43) mlp+attn+unembed (n=43) unembed (n=35)
Figure 21 DishNameBenchmark reveals a bounded LoRA memory law: usable capacity lies around 10−3 − 10−2
tokens per trainable parameter, degrades predictably after saturation, and is most parameter-efficient when memory is written into MLP LoRA.
MLP > Attention ≈ All ≫ Unembed.
From a scale-out perspective, this matters because personal adapters must be cheap to train, store, and serve. If the goal is to maximize memory capacity per parameter, the most efficient design in this benchmark is to trainMLP LoRA only.
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8eWsWi4iu5OPQ42RXH__A04DIWVs3PCbdUXCRfzya_dl2PDiXxZP8WpRpOhezW31HHjJ80k4X6GwNTuPNYIPLIh9BVPC6T_Va5nd6iPbwONT_6C46MntbIe7j6xpxSlCPhFI36Jw=w663-h211-v0?authuser=0)
...
LoRAmemory Skills, habits, policy, persona Persistent behavioral adaptation
Pick Look Clean Heat Cool Pick2 Avg 0.0
0.2
0.4
0.6
0.8
...
235B-base 235B-LoRA r=32 lr=5e-5
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8pc19A9u0INoYQa_qpLMUbw77hfWBGGtYoWAuOTVYmwGe6F8_VgAkbi-wx_GhaVeXTUOPg8noB3Pf10kHsOCnRIpaHoXgb0YVVy3bT6-SclvZ-axZU8xd_yVg9BvA21k3x45PG=w530-h277-v0?authuser=0)
...
1 def context_distill(model, query, build_context, rl_update): 2 # Step 1: query-only produces an on-policy rollout. 3 out = model.sample(query) 4
5 # Step 2: query + context scores the rollout. 6 ctx = build_context(query) 7 r_tok = model.token_reward(query, ctx, out) 8
9 # Step 3: update from the query-only rollout and rewards. 10 return rl_update(model, query, out, r_tok) 11
12 def context_learning(model, queries, build_context, rl_update, steps): 13 for _ in range(steps): 14 query = next(queries) 15 model = context_distill(model, query, build_context, rl_update) 16 return model
Context Distillation: writing context gains into parameters
Step 1 Query-only rollout
Step 2 Context scoring & rewards
Step 3 RL-style parameter update Result
Query
θt
Output
Query
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-eKr7lq7BHfPVd1Q6l13brs3tnhS_HZ78O534_KGVrYBuvwa99uQ5Dh9A-Th3RuysiIRCMFydFRY1UHgTmf8k7SULaM3jDTwaMuu0Nc6KiqiTKDBNvNIIaghCa-ma35O5BWv-U=w127-h173-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8O88eShGppezIbRF-HHuZzBRkqoNWowdyc6yXH1iHBXgygkQoTkwmTZuSDn7aYHes2HlLoJE4J4u7q9ImfURMlHEIP8IgrZmfLRrNL7LsDpf2mwymvH2jiBAVYUsbPKTuRZsvD-A=w345-h187-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_KQLJaZkuKOCtnwCRpz5dkqqhbaCgDQ9UHoQis4et-SvVtSOVVe3J3Ge1a9TRilr8EofPJ0LpBHh325ZQo_nK_l2_I-5sEK8ag1mP8mlketOukaij4cHeU_gXlC-O_9CSdvXU6=w66-h166-v0?authuser=0)
...
Real −0.017 0.472 / / −0.239 0.670 / / BC −0.041 0.389 0.089 0.112 −0.304 0.104 0.104 0.554
Lorenz +0.084 0.725 0.107 0.264 −0.811 0.105 0.572 0.565 Llama −0.053 0.368 0.098 0.105 −0.324 0.405 0.202 0.265 GPT +0.032 0.342 0.081 0.083 −0.256 0.435 0.135 0.238
...
Metric N=128 N=256 N=512 128 → 512
Identity persistence
Final polarization distance +0.388 +0.335 +0.319 – Supportive stance std. 0.340 0.346 0.357 – Skeptical stance std. 0.416 0.339 0.393 –
Population topology
...
Attention cascade
Cascade Gini on likes 0.913 0.866 0.884 – Top-10% post like share 0.859 0.731 0.781 –
...
1 10 100 200 Model count, k (natural-log scale)
36%
38%
40%
42%
...
50%
Ac cu
ra cy**Repetition converged 43.3%**
**Baseline 37.3%**
**k=198, acc=48.7%Collaboration: acc = 0.386 + 0.0172 ln(k)***R2 = 0.888*
Collaboration Repetition Baseline Log fit
Figure24 Model-count scaling by majority vote. Collaboration across distinct LoRA models improves beyond repeated sampling from one model, and the Collaboration curve is approximately linear in ln(k) over the measured range.
...
6.2 Policy Identity: FromAdapterWeights to Adapter Revisions
...
Base deployment A resident dense or MoE foundation
model.
Keeps the expensive shared prior loaded while many adapters change
around it.
Policy record Base version, LoRA rank, target
modules, checkpoints, rollout records, and exported revisions.
Makes an adapted behavior resumable, auditable, and
rollbackable.
Policy session
A temporary trainer restoration with adapter tensors, optimizer moments, scheduler position, gradients, and
rollout metadata.
Allows time-sliced multi-LoRA training without duplicating the base
model.
Adapter revision A fixed exported PEFT adapter in
serving tensor layout.
Defines the behavior selected by rollout, evaluation, serving, and
rollback.
Serving residency Whether an adapter is in shared
storage, CPU cache, or a GPU batch slot.
Lets a large catalog remain addressable while only a bounded
...
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_ZjBmxnXhlXjSyV-sJYzn8OrCZ6I8NqlK_k2-8lFwGZmV2HC1cJtQvoyr6dxJxnQcXMw6nJP55tfI7eOHShL2fh1fYFSMas5tpcDtURMQMep5BjWqfcrCNiLxRcvsM8ypCTt7r_A=w144-h64-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_Y06B-viwknUFueL5Jm_NsEg1d0JMNyNDL8yfxxm8u6NVXIup3F80RLY90ZZRUA-OwjA9lFVh5v3w-ZLfAs0A2Xrwqkc4VCFZG23ik4pvhVGlJVpUuwE0xacvnnB337r8oA0aQ=w144-h64-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX9NPl2ybtPILK1PnO-TKo7zSFL1NSA_D_IfCwZXGxprsn7SNCCdeyanIDWKpE0_QkUWJoIh94Gy_6eM--vahmju9hRNvnO9GXDK1dAwsrmEogkYdFr1SJmdmHnBj2-Ko2EU7xyM=w421-h126-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX_MvdU6GPUyN60AQgfsqbUwjT1CxyY6fRo-L51CbOcspkwhC1-nEEvGoJAHwjX8g6YcMnj763MKleQFHYlAgBgCy51kBXfxe6zoneFIuqc4g70Tm8ub4_5MF1zK-LtezIRCp5PI9g=w1280-h379-v0?authuser=0)
...
6.4 Scale Down Requires Adapter-OnlyMobility
...
Full fine-tuning LoRAmerge MinTmulti-LoRA
Training worker
Moved file
Inference worker
W1
...
Ln
W L1 L2 Ln
blue = trained parameters;W = basemodel;Li = LoRA adapter;W ′ i =merged checkpoint
...
Table9 Adapter-only handoff keeps the moved artifact much smaller than a merged or full checkpoint while preserving the sampling path used for evaluation. Cold first sample is the first request wall time; total sample speed includes that first request, while warm speed excludes it.
Model Path Moved artifact File size Materialization or load
Cold first sample
sample speed total/warm
...
Qwen3-30B Qwen3-30B Adapter rank-16 LoRA 1.692 GB 46.455 s 117.304 s 1.874/5.700 tok/s Qwen3-30B Merge full model 61.084 GB 402.245 s 156.074 s 1.573/6.904 tok/s
...
Servingmap policy→ r
vLLM sampler actor GPU LoRA slots
Lr vLLM
generation
resident model
response tokens
...
request hit: Lr resident selectedLr
fetch r
admitLr
hot path
cold path
...
Addressable catalog
Built and audited a 106-entry packed adapter catalog; serving experiments select bounded working sets from it.
Catalog size is an addressability scale, not simultaneous GPU
residency.
CPU adapter cache 369 loaded adapters at a 512-adapter
hotset; 550 loaded adapters under 2048-adapter weak-locality pressure.
Local CPU memory absorbs recurring traffic before requests
touch shared storage.
GPU batch slots 64 distinct adapters in the tested
same-batch window. Batch execution has the smallest
adapter-diversity window.
Cold loading 16 distinct cache misses form a 1.375–23.267 s load staircase.
Different missing policies must be admitted as explicit service work.
PackedMoE LoRA loading
37,248 tensor objects reduced to 672; live loading becomes 8.5–8.7× faster.
Representation controls cold-load overhead even when adapter bytes
are modest.
Readiness gate Newly registered adapters become
user-visible only after activation/prewarm.
Registration and serving readiness are separate lifecycle states.
![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-uGjA-hyJxE9FiSn1h8mCGf_WHRPhouzh1lU4rO0vIUa_j66FxHAnbmJbtYkWSlvxexvpIaFLH7DgMAQzJ2wrzBy2Dc9E9d1bOftDuXrebADM1E_BSsFWquhMz0cnaC3keSu_Afw=w84-h37-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX-M3f_md7ZkDGKP-vhJyLVYotS9PfTNdg2ZfFalbFPEPfGlcek3v6VG9jnUwp8OxBpsmqRUZ7vdgAd3BJkz4-bVivU862Y6Ua3x7K8z06Fcnfhe_Fl3M5CrqWeq_xszgwOC9ncBTA=w354-h162-v0?authuser=0)

![image](https://lh3.googleusercontent.com/notebooklm/AKYWMX8c3cg0PDrsceAwOdoWzHPs5PNIABuEfGZWTDZ4dmBPUNUaX3VSY3NE7i2DqnXi-1oBGUbWWwfBVm0ygrrTA5Xyl0p18lJ8sCUUs48g2ymOy0gQYzB2IChuTdCnKEs_jy3AFGFfqg=w109-h37-v0?authuser=0)

The MinT serving measurements preserve the distinction between addressability, local residency, and active GPU use. The catalog evidence is an addressability result: MinT builds and audits a 106-entry packed adapter catalog. The local-residency evidence is smaller by design: on one Qwen3-30B rank-1 serving actor, repeatedadapter traffic reaches hundreds of CPU-cached adapters, while the tested same-batch adapter window is 64 distinct adapters. Weak-locality traffic and broad rollout waves expose the cold path: 16 distinct cache misses form a 1.375–23.267 second load staircase, while repeated requests for the same missing policy can share one load. These numbers are the evidence for the residency boundary that Scale Out needs: policy count can be large only if catalog lookup, CPU cache, GPU batch slots, and cold activation are treated as different service scales.
...
Admission off post TTFT p95 24.03 s; >20 s stalls: 10
e2e p95 59.18 s; user TTFT p95 22.19 s; load p95 47.37 s
Fast exposure, but cold first-touch disrupts warm
tenants.
Admission on post TTFT p95 9.71 s; >20 s stalls: 0
e2e p95 314.79 s; user TTFT p95 10.68 s; load p95 294.96 s
Admission protects warm tenants, but new users wait
behind activation.
Expose after readiness
Two-phase readiness post TTFT p95 9.63 s; >20 s stalls: 0
ready-path TTFT p95 4.60 s; load p95 0.00 s; prewarm span 409.04 s
First user requests arrive after activation, so they do
not load adapters.
...
Adapter-file shape File size 110.75 MB 105.58 MB 1.05× smaller
Tensor objects 37,248 672 55.4× fewer Cold-load slice
Read tensors 0.3669 s 0.0067 s 54.8× faster Build loader objects 0.7540 s 0.0256 s 29.5× faster
Live engine loading N=4 live load 1.363 s 0.156 s 8.7× faster N=8 live load 1.361 s 0.159 s 8.6× faster N=16 live load 1.388 s 0.164 s 8.5× faster
...
2. ScaleUp (Tiny-adapter reliability): low-rank LoRA already shows signal on strong priors, but must become stable under seed, batch, and task variation before it can serve as a repeatable adaptation substrate.
...
5. ScaleOut (LoRAmemory and skill capacity): the bounded capacity law for parametric memory observed on simple benchmarks needs to be extended to RL-trained, multi-task adapters, where the open question
...
Changhai Zhou, Shijie Han, Lining Yang, Yuhua Zhou, Xu Cheng, Yibin Wang, and Hongguang Li. RankAdaptor: Hierarchical rank allocation for efficient fine-tuning pruned LLMs via performance model. In Findings of the Asso-ciation for Computational Linguistics: NAACL 2025, pages 5796–5810. Association for Computational Linguistics, 2025a. URL https://aclanthology.org/2025.findings-naacl.321/.
